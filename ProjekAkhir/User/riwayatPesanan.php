        ...
        <div class="product">
            <?php foreach ($product as $prdt) : ?>
                <?php foreach ($pesanan as $order) : ?>
                    <?php if ($order['id_product'] == $prdt['id_product'] && $order['status'] == 'Diterima') : ?>
                        <div class="item">
                        <h1 name="produk" id="produk"><?php echo $prdt['name']; ?></h1>
                        <img src="../upload/<?php echo $prdt['gambar']; ?>" alt="Image Eskrim" width='200'>
                        ...
                        <!-- <div class="status">
                            <button><?php echo $order['status']; ?></button>
                        </div> -->
                    <?php endif; ?>
                <?php endforeach; ?>
            <?php endforeach; ?>
